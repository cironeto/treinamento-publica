...
public class LoginService {
	...
	// Método publico do login, chama os métodos de validação do username e senha.
	 ...
	 * vezes, chama o método de bloqueio
	 */
	...
	/*
	 * Método publico da recuperação de senha, chama o método que valida a
	...
	/*
	 * método que valida a existencia do usario e seta a variavel estatica com o
	 * indice encontrado.
	 */
	...
	/*
	 * Chama métodos de validação do email ou telefone. Chama o método para a
	 * alteração da senha. Também chama o método de bloqueio caso haja 3 tentativas
	 * erradas.
	 */
	...
	/*
	 * Método chama input para validar se o telefone ou email do usuario que deseja recuperar a senha
	 */
	...
	/*
	 * Método chama input para validar a resposta secreta do usuario que deseja recuperar a senha
	 */
	private static boolean validaRespostaSecreta(List<Usuario> usuarios) {
		return JOptionPane.showInputDialog("Qual é a resposta da pergunta secreta?")
	...
	/*
	 * Método faz o bloqueio do sistema por alguns segundos caso as tentativas de acesso ou 
	 * recuperação de senha chegue em 3 vezes.
	 */
	private static int bloqueiaAcessoRetornaOpcao() throws InterruptedException {
		...
		Thread.sleep(2000);
		tentativasErradas = 0;
		return JOptionPane.showConfirmDialog(null, "VOCÊ ESPEROU POR ''TRÊS MINUTOS''! \n Deseja tentar novamente?");
	}
}
