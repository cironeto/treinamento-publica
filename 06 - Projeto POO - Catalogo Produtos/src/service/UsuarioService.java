...
public class UsuarioService implements Crud<Usuario> {
	...
	/*
	 * Lista os usuarios e recebe o ID para alterar os dados. Chama método privado para 
	...
	/*
	 * Lista os usuarios e recebe o ID para remover os dados. Valida se o usuario está o proprio
	 * usuario. 
	 */
	@Override
	 ...
	 * Valida se o nível é aceito para cadastro.
	 */
	...
	/*
	 * Recebe entradas dos atributos do usarios para alteração. Username e nível não são alterados. 
	 */
	private static void solicitaDadosUsuarioEAtualizaArrayList(List<Usuario> usuarios, int indiceUsuarioSelecionado) {
		JOptionPane.showMessageDialog(null, "Username e Nível não podem ser alterados, atualize os outros campos");
	...
	/*
	 * Verifica se o username digitado já existe no ArrayList.
	 */
