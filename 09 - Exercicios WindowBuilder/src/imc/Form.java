	...
	public Form() {
		...
		btnCalcular.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(imc < 17.5) {
					lblResultado.setText("IMC: " + imc + " Condição: Abaixo do peso");
				}else if(imc >= 17.5 && imc < 25) {
					lblResultado.setText("IMC: " + imc + " Condição: Peso Normal");
				}else if(imc >= 25 && imc < 30) {
					lblResultado.setText("IMC: " + imc + " Condição: Acima do peso");
				}else if(imc >= 30 && imc < 35) {
					lblResultado.setText("IMC: " + imc + " Condição: Obesidade 1");
				}else if(imc >= 35 && imc < 40) {
					lblResultado.setText("IMC: " + imc + " Condição: Obesidade 2");
				}else if(imc >= 40) {
					lblResultado.setText("IMC: " + imc + " Condição: Obesidade 3");
				}
			}
		});
